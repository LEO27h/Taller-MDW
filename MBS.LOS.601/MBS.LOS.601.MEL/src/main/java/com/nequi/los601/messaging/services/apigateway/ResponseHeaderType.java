 ...
 *         &lt;element name="status" type="{http://nequi.co/message/integration/services/agi/}statusType"/>
...
@XmlType(name = "responseHeaderType", namespace = "http://nequi.co/message/integration/services/agi/", propOrder = {
    "messageID",
    "status",
    "responseDate",
    "channel"
